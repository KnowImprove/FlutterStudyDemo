...
class FragmentWx extends StatefulWidget {
  int id;

  FragmentWx(this.id, {Key? key}) : super(key: key);

  @override
  _AState createState() => _AState(id);
}

class _AState extends State<FragmentWx> with AutomaticKeepAliveClientMixin {
