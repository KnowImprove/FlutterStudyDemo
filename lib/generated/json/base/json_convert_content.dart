...
class JsonConvert {
  ...
  static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
    ...
    if (type == (CoinListResponseModelEntity).toString()) {
      return CoinListResponseModelEntity.fromJson(json) as M;
    }
    if (type == (CoinListResponseModelData).toString()) {
      return CoinListResponseModelData.fromJson(json) as M;
    }
    if (type == (CoinListResponseModelDataDatas).toString()) {
      return CoinListResponseModelDataDatas.fromJson(json) as M;
    }
    if (type == (CollectDataResponseEntity).toString()) {
      return CollectDataResponseEntity.fromJson(json) as M;
    }
    if (type == (CollectDataResponseData).toString()) {
      return CollectDataResponseData.fromJson(json) as M;
    }
    if (type == (CollectDataResponseDataDatas).toString()) {
      return CollectDataResponseDataDatas.fromJson(json) as M;
    }
    ...
    if (type == (UserInfoModelResponseEntity).toString()) {
      return UserInfoModelResponseEntity.fromJson(json) as M;
    }
    if (type == (UserInfoModelResponseData).toString()) {
      return UserInfoModelResponseData.fromJson(json) as M;
    }
    if (type == (UserInfoModelResponseDataCoinInfo).toString()) {
      return UserInfoModelResponseDataCoinInfo.fromJson(json) as M;
    }
    if (type == (UserInfoModelResponseDataUserInfo).toString()) {
      return UserInfoModelResponseDataUserInfo.fromJson(json) as M;
    }
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<CoinListResponseModelEntity>[] is M) {
      return data
          .map<CoinListResponseModelEntity>((Map<String, dynamic> e) =>
              CoinListResponseModelEntity.fromJson(e))
          .toList() as M;
    }
    if (<CoinListResponseModelData>[] is M) {
      return data
          .map<CoinListResponseModelData>(
              (Map<String, dynamic> e) => CoinListResponseModelData.fromJson(e))
          .toList() as M;
    }
    if (<CoinListResponseModelDataDatas>[] is M) {
      return data
          .map<CoinListResponseModelDataDatas>((Map<String, dynamic> e) =>
              CoinListResponseModelDataDatas.fromJson(e))
          .toList() as M;
    }
    if (<CollectDataResponseEntity>[] is M) {
      return data
          .map<CollectDataResponseEntity>(
              (Map<String, dynamic> e) => CollectDataResponseEntity.fromJson(e))
          .toList() as M;
    }
    if (<CollectDataResponseData>[] is M) {
      return data
          .map<CollectDataResponseData>(
              (Map<String, dynamic> e) => CollectDataResponseData.fromJson(e))
          .toList() as M;
    }
    if (<CollectDataResponseDataDatas>[] is M) {
      return data
          .map<CollectDataResponseDataDatas>((Map<String, dynamic> e) =>
              CollectDataResponseDataDatas.fromJson(e))
          .toList() as M;
    }
    ...
    if (<UserInfoModelResponseEntity>[] is M) {
      return data
          .map<UserInfoModelResponseEntity>((Map<String, dynamic> e) =>
              UserInfoModelResponseEntity.fromJson(e))
          .toList() as M;
    }
    if (<UserInfoModelResponseData>[] is M) {
      return data
          .map<UserInfoModelResponseData>(
              (Map<String, dynamic> e) => UserInfoModelResponseData.fromJson(e))
          .toList() as M;
    }
    if (<UserInfoModelResponseDataCoinInfo>[] is M) {
      return data
          .map<UserInfoModelResponseDataCoinInfo>((Map<String, dynamic> e) =>
              UserInfoModelResponseDataCoinInfo.fromJson(e))
          .toList() as M;
    }
    if (<UserInfoModelResponseDataUserInfo>[] is M) {
      return data
          .map<UserInfoModelResponseDataUserInfo>((Map<String, dynamic> e) =>
              UserInfoModelResponseDataUserInfo.fromJson(e))
          .toList() as M;
    }
