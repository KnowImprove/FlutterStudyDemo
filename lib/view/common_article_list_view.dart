...
import '../model/base_article_item_bean_entity.dart';
...
class CommonArticleList<T extends BaseArticleItemBeanEntity>
...
class _CommonArticleListState<T extends BaseArticleItemBeanEntity>
    extends State<CommonArticleList> {
  int _page = 0;
